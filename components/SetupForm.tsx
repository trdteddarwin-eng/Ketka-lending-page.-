...
export const SetupForm: React.FC<SetupFormProps> = ({ onComplete, isLoading }) => {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="max-w-md mx-auto p-4 md:p-6 bg-white rounded-xl border border-gray-200 shadow-xl"
    >
      <motion.div variants={itemVariants} className="text-center mb-4">
        <div className="inline-flex items-center justify-center w-12 h-12 bg-black rounded-full mb-3 shadow-lg shadow-black/20">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
          </svg>
        </div>
        <h1 className="text-xl md:text-2xl font-bold text-slate-900 mb-1">Try the AI Receptionist</h1>
        <p className="text-slate-500 text-sm">Fill in your info for a personalized demo.</p>
      </motion.div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <motion.div variants={itemVariants}>
            ...
            <input
              type="text"
              required
              className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent text-slate-900 placeholder-slate-400 transition-all outline-none text-sm"
              placeholder="Alex"
